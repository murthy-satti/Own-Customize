      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 max-w-full dark:border-b border-gray-600">
        <div className="flex flex-wrap justify-between items-center min-h-16 py-2 gap-2 ">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-4 lg:gap-8 items-center">
            <Link
              to="/"
              className={`px-2 sm:px-3 py-2 rounded-md text-sm sm:text-lg font-semibold transition-colors whitespace-nowrap ${isActive('/')
            ...
            <Link
              to="/components"
              className={`px-2 sm:px-3 py-2 rounded-md text-sm sm:text-lg font-semibold transition-colors whitespace-nowrap ${isActive('/components')
                  ? 'text-blue-600 bg-blue-50 dark:text-blue-400 dark:bg-slate-800'
                  : 'text-gray-700 hover:text-blue-600 hover:bg-gray-50 dark:text-gray-300 dark:hover:text-blue-400 dark:hover:bg-slate-800'
                }`}
            >
            ...
            <Link
              to="/customize"
              className={`px-2 sm:px-3 py-2 rounded-md text-sm sm:text-lg font-semibold transition-colors whitespace-nowrap ${isActive('/customize')
                  ? 'text-blue-600 bg-blue-50 dark:text-blue-400 dark:bg-slate-800'
                  : 'text-gray-700 hover:text-blue-600 hover:bg-gray-50 dark:text-gray-300 dark:hover:text-blue-400 dark:hover:bg-slate-800'
                }`}
            >
