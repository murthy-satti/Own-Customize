...
const Home: React.FC = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900">
      {/* Hero Section */}
      <div className="w-full px-4 sm:px-6 lg:px-8 py-20 border-b border-gray-200 dark:border-slate-700">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            ...
            <Link
              to="/components"
              className="inline-flex items-center gap-2 px-8 py-4 border-2 border-gray-300 dark:border-slate-600 text-gray-700 dark:text-gray-300 font-semibold rounded-lg hover:bg-gray-50 dark:hover:bg-slate-800 hover:border-gray-400 dark:hover:border-slate-500 transition-all"
            >
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-20 bg-slate-100 dark:bg-slate-800">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 bg-white dark:bg-slate-900 rounded-lg shadow-sm hover:shadow-md transition-all border border-gray-200 dark:border-slate-700">
              <div className="w-14 h-14 bg-blue-700 rounded-lg flex items-center justify-center mb-6">
                <Package className="w-7 h-7 text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">Extensive Component Library</h3>
            ...
            <div className="p-8 bg-white dark:bg-slate-900 rounded-lg shadow-sm hover:shadow-md transition-all border border-gray-200 dark:border-slate-700">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">Visual Editor</h3>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <div className="p-8 bg-white dark:bg-slate-900 rounded-lg shadow-sm hover:shadow-md transition-all border border-gray-200 dark:border-slate-700">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">Production-Ready Code</h3>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
      ...
      <div className="bg-white dark:bg-slate-900 py-20 border-t border-gray-200 dark:border-slate-700">
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-12 relative">
              {/* Connection Lines */}
              <div className="hidden md:block absolute top-16 left-1/4 right-1/4 h-0.5 bg-gray-300 dark:bg-slate-600"></div>
              ...
              <div className="relative text-center">
                <div className="relative inline-block mb-6">
                  ...
                  <div className="absolute -top-2 -right-2 w-8 h-8 bg-gray-900 dark:bg-slate-700 text-white rounded-full flex items-center justify-center text-sm font-bold">
                    1
                  </div>
                </div>
